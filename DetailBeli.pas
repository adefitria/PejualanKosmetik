...
// Menampilkan Id_Penjulan ke dalam ComboBox
cbb3.Items.Clear;
zqry3.SQL.Clear;
zqry3.SQL.Add('SELECT id FROM tabel_pembelian');
zqry3.Open;

// Menampilkan Id_Supplier  ke dalam ComboBox
cbb1.Items.Clear;
zqry2.SQL.Clear;
zqry2.SQL.Add('SELECT id FROM tabel_supplier');
zqry2.Open;
...
cbb2.Items.Clear;
zqry3.SQL.Clear;
zqry3.SQL.Add('SELECT id FROM tabel_barang');
zqry3.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('SELECT * FROM tabel_detailpembelian');
zqry1.Open;
...
begin
  ...
  begin
  zqry1.SQL.Clear;
  zqry1.SQL.Add('insert into tabel_detailpembelian values (null,"'cbb3.Text+'","'+cbb1.Text+'","'+cbb2.Text+'","'+Edtqty.Text+'","'+Edtharga.Text+'","'+Edttotal.Text+'")');
  zqry1.ExecSQL;
...
cbb3.Text:= zqry1.FieldList[1].AsString;
cbb1.Text:= zqry1.FieldList[2].AsString;
cbb2.Text:= zqry1.FieldList[3].AsString;
Edtqty.Text:= zqry1.FieldList[4].AsString;
Edtharga.Text:= zqry1.FieldList[5].AsString;
...
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tabel_detailpembelianbeli where id="'+id+'"');
zqry1.ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tabel_detailpembelian');
zqry1.Open;
...
begin
  ...
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update tabel_detailpembelian set id_supplier="'+cbb1.Text+'", barang_id="'+cbb2.Text+'", qty="'+Edtqty.Text+'", harga_beli="'+Edtharga.Text+'", total="'+Edttotal.Text+'" where id="'+id+'"');
  zqry1.ExecSQL;
  zqry1.SQL.Clear;
  zqry1.SQL.Add('select*from tabel_detailpembelian');
  zqry1.Open;
