...
zqry1.SQL.Clear;
zqry1.SQL.Add('SELECT * FROM tabel_detailpenjualan');
zqry1.Open;
...
begin
  ...
  begin
  zqry1.SQL.Clear;
  zqry1.SQL.Add('insert into tabel_detailpenjualan values (null,"'+cbb1.Text+'","'+cbb2.Text+'","'+Edtqty.Text+'","'+Edtharga.Text+'","'+Edttotal.Text+'","'+cbb3.Text+'")');
  zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tabel_detailpenjualan where id="'+id+'"');
zqry1.ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tabel_detailpenjualan');
zqry1.Open;
...
begin
  ...
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update tabel_detailpenjualan set id_penjualan="'+cbb1.Text+'", id_barang="'+cbb2.Text+'", qty="'+Edtqty.Text+'", harga_jual="'+Edtharga.Text+'", total_jual="'+Edttotal.Text+'", status="'+cbb3.Text+'" where id="'+id+'"');
  zqry1.ExecSQL;
  zqry1.SQL.Clear;
  zqry1.SQL.Add('select*from tabel_detailpenjualan');
  zqry1.Open;
