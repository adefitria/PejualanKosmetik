...
// Menampilkan id_penjualan  ke dalam ComboBox
cbb1.Items.Clear;
zqry2.SQL.Clear;
zqry2.SQL.Add('SELECT id FROM tabel_penjualan');
zqry2.Open;
...
cbb4.Items.Clear;
zqry4.SQL.Clear;
zqry4.SQL.Add('SELECT id FROM tabel_user');
zqry4.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('SELECT * FROM tabel_return');
zqry1.Open;
...
begin
  ...
  begin
  zqry1.SQL.Clear;
  zqry1.SQL.Add('insert into tabel_return values (null,"'+FormatDateTime('yyyy-mm-dd', dtp1.Date)+'","'+cbb1.Text+'","'+cbb2.Text+'","'+cbb4.Text+'","'+Edtqty.Text+'","'+Edtharga.Text+'","'+Edttotal.Text+'","'+cbb3.Text+'")');
  zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tabel_return where id="'+id+'"');
zqry1.ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tabel_return');
zqry1.Open;
...
begin
  ...
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update tabel_return set tgl_return="'+FormatDateTime('yyyy-mm-dd', dtp1.Date)+'", penjualan_id="'+cbb1.Text+'", barang_id="'+cbb2.Text+'", user_id="'+cbb4.Text+'", qty="'+Edtqty.Text+'", harga_jual="'+Edtharga.Text+'", total_jual="'+Edttotal.Text+'", status="'+cbb3.Text+'" where id="'+id+'"');
  zqry1.ExecSQL;
  zqry1.SQL.Clear;
  zqry1.SQL.Add('select*from tabel_return');
  zqry1.Open;
